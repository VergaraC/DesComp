...
-- *****************************************************************************
-- Generated on "11/25/2021 15:21:39"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          UlaTotal
-- 
...
ENTITY UlaTotal_vhd_vec_tst IS
END UlaTotal_vhd_vec_tst;
ARCHITECTURE UlaTotal_arch OF UlaTotal_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL entradaA : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL entradaAsaida : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL entradaB : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL entradaBsaida : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL FlagZ : STD_LOGIC;
SIGNAL saida : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL Seletor : STD_LOGIC_VECTOR(2 DOWNTO 0);
SIGNAL SeletorSaida : STD_LOGIC_VECTOR(2 DOWNTO 0);
COMPONENT UlaTotal
	PORT (
...
-- list connections between master ports and signals
	entradaA => entradaA,
	entradaAsaida => entradaAsaida,
	entradaB => entradaB,
	entradaBsaida => entradaBsaida,
	FlagZ => FlagZ,
	saida => saida,
	Seletor => Seletor,
	SeletorSaida => SeletorSaida
	);
-- entradaA[31]
