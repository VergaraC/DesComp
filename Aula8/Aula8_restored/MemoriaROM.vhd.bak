...
-- Incremento 1X
tmp(52) := LDA & '0' & x"00"; -- Pega o Valor 1X
...
tmp(60) := LDA & '0' & x"01"; -- Pega o Valor 10X
...
tmp(68) := LDA & '0' & x"02"; -- Pega o Valor 100X
...
tmp(76) := LDA & '0' & x"03"; -- Pega o Valor 1000X
...
tmp(84) := LDA & '0' & x"04"; -- Pega o Valor 10000X
...
tmp(92) := LDA & '0' & x"05"; -- Pega o Valor 100000X
...
tmp(103) := STA & '0' & x"00"; -- Armazena 0 no 1X
tmp(104) := STA & '0' & x"01"; -- Armazena 0 no 10X
tmp(105) := STA & '0' & x"02"; -- Armazena 0 no 100X
tmp(106) := STA & '0' & x"03"; -- Armazena 0 no 1000X
tmp(107) := STA & '0' & x"04"; -- Armazena 0 no 10000X
tmp(108) := STA & '0' & x"05"; -- Armazena 0 no 100000X    
...
-- atualiza Valores
tmp(113) := LDA & '0' & x"00"; -- Pega o Valor 1X
tmp(114) := STA & '1' & x"20"; -- Salva no HEX0   
tmp(115) := LDA & '0' & x"01"; -- Pega o Valor 10X
tmp(116) := STA & '1' & x"21"; -- Salva no HEX1
tmp(117) := LDA & '0' & x"02"; -- Pega o Valor 100X
tmp(118) := STA & '1' & x"22"; -- Salva no HEX2   
tmp(119) := LDA & '0' & x"03"; -- Pega o Valor 1000X
tmp(120) := STA & '1' & x"23"; -- Salva no HEX3   
tmp(121) := LDA & '0' & x"04"; -- Pega o Valor 10000X
tmp(122) := STA & '1' & x"24"; -- Salva no HEX4
tmp(123) := LDA & '0' & x"05"; -- Pega o Valor 100000X
tmp(124) := STA & '1' & x"25"; -- Salva no HEX5    
tmp(125) := RET & '0' & x"00"; -- Return

--checando limites
tmp(126) := LDA & '0' & x"14"; -- Carrega limite 1X
tmp(127) := CEQ & '0' & x"00"; -- Compara 1X e o seu limite
tmp(128) := JEQ & '0' & x"82"; -- Efetua o Jump (Address[130])
tmp(129) := RET & '0' & x"00"; -- Return

tmp(130) := LDA & '0' & x"15"; -- Carrega limite 10X
tmp(131) := CEQ & '0' & x"01"; -- Compara 10X e o seu limite
tmp(132) := JEQ & '0' & x"86"; -- Efetua o Jump (Address[134])
tmp(133) := RET & '0' & x"00"; -- Return

tmp(134) := LDA & '0' & x"16"; -- Carrega limite 100X
tmp(135) := CEQ & '0' & x"02"; -- Compara 100X e o seu limite
tmp(136) := JEQ & '0' & x"8A"; -- Efetua o Jump (Address[138])
tmp(137) := RET & '0' & x"00"; -- Return

tmp(138) := LDA & '0' & x"17"; -- Carrega limite 1000X
tmp(139) := CEQ & '0' & x"03"; -- Compara 1000X e o seu limite
tmp(140) := JEQ & '0' & x"8E"; -- Efetua o Jump (Address[142])
tmp(141) := RET & '0' & x"00"; -- Return

tmp(142) := LDA & '0' & x"18"; -- Carrega limite 10000X
tmp(143) := CEQ & '0' & x"04"; -- Compara 10000X e o seu limite
tmp(144) := JEQ & '0' & x"92"; -- Efetua o Jump (Address[146])
tmp(145) := RET & '0' & x"00"; -- Return 

tmp(146) := LDA & '0' & x"19"; -- Carrega limite 100000X
tmp(147) := CEQ & '0' & x"05"; -- Compara 100000X e o seu limite
...
tmp(161) := STA & '0' & x"14"; -- Guarda limite 1X    
...
tmp(169) := STA & '0' & x"15"; -- Guarda limite 10X 
...
tmp(177) := STA & '0' & x"16"; -- Armazena novo limite para 100X
...
tmp(185) := STA & '0' & x"17"; -- Armazena novo limite para 1000X
...
tmp(193) := STA & '0' & x"18"; -- Armazena novo limite para 10000X
...
tmp(201) := STA & '0' & x"19"; -- Armazena novo limite para 100000X
